import { DEFAULT_MAX_UPVOTES, DEFAULT_MIN_UPVOTES, } from './reddit/constants';
import { clampMaxUpvotes, clampMinUpvotes, } from './reddit/parseMaxUpvotes';
export const STORAGE_KEY_MAX_UPVOTES = 'redditdle_maxUpvotes';
export const STORAGE_KEY_MIN_UPVOTES = 'redditdle_minUpvotes';
export function loadMaxUpvotes() {
...
export function loadMinUpvotes() {
    if (typeof window === 'undefined') {
...
export function loadUpvoteLimits() {
    if (typeof window !== 'undefined') {
